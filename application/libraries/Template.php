...
class CI_Template {
   ...
   // --------------------------------------------------------------------
    ...
    /**
      * Custom create template views method
      *
      * @access	public
      * @param 	string	$customView The content view passed to the content section of the template by the controller
      * @param	array	$data       Optional data array
      * @return void
      */
	 
	// create the views that will be used on every page for the template
	public function create_template_views($customView, $data = null) {
		//$CI =& get_instance();

       $this->write_view('headbar', 'main/headbar', $data);
       $this->write_view('header', 'main/header', $data);
       $this->write_view('breadcrumb', 'main/breadcrumb', $data);
       $this->write_view('content', $customView, $data);
       $this->write_view('rightAside', 'main/right_aside', $data);
       $this->write_view('footer', 'main/footer', $data);
	}
